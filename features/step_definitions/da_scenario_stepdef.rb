...
Then(/^I select services for second building "([^"]*)" - DA scenario two$/) do |building_name|
  ...
  home.service_selection.compliance_plans[1].click
  home.service_selection.condition_survey[1].click
  home.service_selection.electrical_testing[1].click
  home.service_selection.fire_risk[1].click
  home.service_selection.portable_appliance[1].click
  home.service_selection.statutory_inspections[1].click
  home.service_selection.water_hygiene[1].click
  home.service_selection.cleaning_external[1].click
  home.service_selection.cleaning_integral[1].click
  home.service_selection.deep_periodic_clean[1].click
  home.service_selection.mobile_cleaning[1].click
  home.service_selection.pest_control[1].click
  home.service_selection.external_window_cleaning[1].click
  home.service_selection.internal_window_cleaning[1].click
...
Then(/^I select services for fourth building "([^"]*)" - DA scenario two$/) do |building_name|
  #building_one
  click_on building_name
  home.service_selection.classified_waste[3].click
  home.service_selection.feminine_hygiene[3].click
  home.service_selection.general_waste[3].click
  home.service_selection.recycled_waste[3].click
  home.service_selection.cafm[3].click
  home.service_selection.helpdesk[3].click
  home.service_selection.management_billable[3].click
