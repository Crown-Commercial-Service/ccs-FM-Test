Feature: Assessed value Scenario B - Case Eleven
  ...
  Scenario Outline: 11-   CP, CAFM, Helpdesk TUPE, V is within of 30% (Neg left boundary)
    ...
    And I click on "Continue"
    And I should see the price displayed £11,861,713.80
