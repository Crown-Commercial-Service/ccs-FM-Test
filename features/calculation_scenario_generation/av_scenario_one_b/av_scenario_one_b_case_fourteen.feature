Feature: Assessed value Scenario B - Case Fourteen
  ...
  Scenario Outline: 14-  CP, CAFM, Helpdesk TUPE, V is out of 30% (Neg right boundary)
    ...
    And I click on "Back to detailed search summary"
    And I click on "Continue"
    And I should see the price displayed £117,530,000.00
