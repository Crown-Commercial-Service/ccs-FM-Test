Feature: Assessed value Scenario B - Case Five
  ...
  Scenario Outline: 5-   CP, CAFM, Helpdesk TUPE, V is within of 30% (Neg left boundary)
    ...
    And I click on "Continue"
    And I should see the price displayed £1,710,780.37
