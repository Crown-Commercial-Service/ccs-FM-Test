Feature: Assessed value Scenario B - Case Ten
  ...
  Scenario Outline: 10-  CP, CAFM, Helpdesk TUPE, V is out of 30% (Neg right boundary)
    ...
    And I click on "Continue"
    And I should see the price displayed £18,361,000.00
