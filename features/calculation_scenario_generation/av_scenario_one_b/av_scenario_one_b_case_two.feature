Feature: Assessed value Scenario B - Case Two
  ...
  Scenario Outline: 2-  CP, No CAFM, Helpdesk TUPE, V is out of 30% (Neg right boundary)
...
#    And I select seventh building "London building" with address "2 Marylebone Road, London, Inner London - West, NW1 4DF"
    ...
    And I click on "Continue"
    And I should see the price displayed £1,573,500.00
