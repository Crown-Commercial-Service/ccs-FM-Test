...
#    And I select third building "Birmingham" with address "255 Yardley Green Road, Birmingham, West Midlands, B9 5QA"
#    And I select sixth building "Coventry House" with address "68 Kingsbury Road, Coventry, West Midlands, CV6 1PH"
#    And I select eight building "Luton Building" with address "31 Hillborough Crescent, Houghton Regis, Dunstable, Bedfordshire and Hertfordshire, LU5 5NU"
#    And I select ninth building "Manchester Building" with address "40 Raby Street, Manchester, Greater Manchester, M16 7GH"
##    And I select seventh building "Northern Ireland" with address "Hampden House, 55 Royal Avenue, Belfast, Belfast, BT1 1FX"
#    And I select eleventh building "Outer Belfast" with address "15 The Diamond, Londonderry, North of Northern Ireland, BT48 6HW"
#    And I select thirteen building "Swansea" with address "Ty Gwalia 7-13, 7 The Kingsway, Swansea, Swansea, SA1 5JN"
#    And I select fourteen building "Westminster Building" with address "10 Downing Street, London, Inner London - West, SW1A 2AA"
#    And I select fifteen building "Wolverhampton" with address "101 Ward Street, Wolverhampton, West Midlands, WV2 2AA"
#    And I click on "Save and continue"
#    And I am on "Which facilities management services do you need for each building?" page
##    And the first building is selected
#    And I select services for first building "Aberdeen" - DA scenario one
#    And I select services for second building "Belfast Building" - DA scenario one
#    And I select services for third building "Birmingham" - DA scenario one
#    And I select services for fourth building "Coventry House" - DA scenario one
#    And I select services for fifth building "Luton Building" - DA scenario one
#    And I select services for sixth building "Manchester Building" - DA scenario one
#    And I select services for seventh building "Outer Belfast" - DA scenario one
#    And I select services for eighth building "Swansea" - DA scenario one
#    And I select services for ninth building "Westminster Building" - DA scenario one
#    And I select services for tenth building "Wolverhampton" - DA scenario one
