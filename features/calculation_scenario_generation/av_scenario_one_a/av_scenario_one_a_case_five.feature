Feature: Assessed value Scenario A - Case Five
  ...
  Scenario Outline: Scenario 5 - CP, CAFM, Helpdesk TUPE, V is within of 30% (Neg Left boundary)
    And I click on the "CAFM"
...
#    And I select twelfth building "Outside London building" with address "10 Kenton Avenue, Manchester, Greater Manchester, M18 7GQ"
    ...
    And I click on "Continue"
    And I should see the price displayed £1,651,140.96
