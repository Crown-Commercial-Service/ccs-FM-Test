Feature: Assessed value Scenario A - Case Fourteen
  ...
  Scenario Outline: 14-  CP, No CAFM, Helpdesk TUPE, V is out of 30% (Positive Right boundary)
...
#    And I select seventh building "London building" with address "2 Marylebone Road, London, Inner London - West, NW1 4DF"
    ...
    And I click on "Continue"
    And I should see the price displayed £80,330,955.59
