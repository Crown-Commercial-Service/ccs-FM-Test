Feature: Assessed value Scenario A - Case Eleven
  ...
  Scenario Outline: 11-  CP, CAFM, Helpdesk TUPE, V is within of 30% (Neg right  boundary)
    ...
    And I click on "Continue"
    And I should see the price displayed £14,853,807.63
