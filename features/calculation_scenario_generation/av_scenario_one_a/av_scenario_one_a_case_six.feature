Feature:Assessed value Scenario A - Case Six
  ...
  Scenario Outline: Scenario 6-  CP, CAFM, Helpdesk TUPE, V is out of 30% (Neg Right boundary)
...
#    And I select twelfth building "Outside London building" with address "10 Kenton Avenue, Manchester, Greater Manchester, M18 7GQ"
    ...
    And I click on "Continue"
    And I should see the price displayed £1,498,903.19
