Feature: Assessed value Scenario B - Case Four
  ...
  Scenario Outline: Scenario 4  CP, No CAFM, Helpdesk TUPE, V is out of 30% (Positive Right boundary)
...
#    And I select seventh building "London building" with address "2 Marylebone Road, London, Inner London - West, NW1 4DF"
    ...
    And I click on "Continue"
    And I should see the price displayed £2,052,142.41
